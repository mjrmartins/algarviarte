...
$brinco = selectSQLUnico("SELECT * FROM brincos_destaques WHERE id=$id");
...
if($form2){
    ...
    iduSQL("UPDATE brincos_destaques SET imagem='$imagem', referencia='$referencia' WHERE id='$id'");
    header("Location: brincos_destaques.php");
    exit();
}
