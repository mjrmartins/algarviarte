...
$brincosDestaques = getTodosBrincosDestaques();
...
<main class="container mt-3 px-0 mx-auto">
    ...
    <div class="row mt-3 mb-2 px-0 mx-0 text-center tabela">
        <form action="novo_brinco_destaque.php" class="mb-3">
            <button name="criar" value="" class="close2">adicionar novo</button>
        </form>

        <form action="editar_texto_brincos.php" class="mb-3">
            <button name="editarTexto" value="destaques.php" class="close2">editar textos</button>
        </form>
        ...
        <table>
            ...
            <?php foreach($brincosDestaques as $b): ?>
            <tr>
                <td><?= $b["id"]; ?></td>
                <td><?= $b["referencia"]; ?></td>
                <td><img src="<?= getImagemBrincosDestaques($b["id"]); ?>" class="img-backoffice" alt="imagem_brinco" />
                </td>
                <td>
                    <form action="editar_brinco_destaque.php">
                        <button name="editar" value="<?= $b["id"]; ?>" class="editar">e</button>
                    </form>
                </td>
                <td>
                    <form action="apagar_brinco_destaque.php">
