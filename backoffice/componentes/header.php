<?php
ob_start(); //necessário para evitar o envio prévio da informação pelo header. Depois de incorporar o CKEditor, só com o ob_start() é possível retornar à página que desejamos após o envio de informação a atualizar. Por exemplo, após editar os contactos, o header location direciona para a página contactos. Com a introdução do CKEditor, isto estava a dar problema, visto que a informação havia já sido enviada pelo header. O ob_start() retém essa informação e evita que seja enviada previamente, sendo enviada só depois com o header location.
